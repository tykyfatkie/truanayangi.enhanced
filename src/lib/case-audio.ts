const names = ['csgo_ui_crate_drop', 'csgo_ui_crate_unlock', 'csgo_ui_crate_item_scroll', 'csgo_ui_button_click', 'item_reveal3_rare', 'item_reveal4_mythical', 'item_reveal5_legendary', 'item_reveal6_ancient'] as const;
